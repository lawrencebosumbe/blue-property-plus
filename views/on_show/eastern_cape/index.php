    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Property in Eastern Cape</h1>
                ...
                <div class="row city">       
                	<ul>       
                        <?php foreach($cities->getEasternCapeCities() as $city): ?> 
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getEasternCapePropertyListImagesOnShow() as $property):
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                     
                        ...
                        <ul class="sponsors-logos">
                          <li class="sponsors__item">
                            <a href="#"><img src="<?php echo URL; ?>public/images/sponsors/blue-logo-white.png" alt=""></a>
                          </li>
                          <!--
                          <li class="sponsors__item">
