        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getUmngeniCities($municRow->getMunicipalityID()) as $property):
						...
						$propertySingleURL = URL.'umngeni/'.'on_show_city/'.$property->getCityID().'/';
					?>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getUmngeniPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'umngeni/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'umngeni/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
