<?php 
	...
	/*
	 Right sidebar property city info
	 -----------------------------------------------------------------
	*/
	...
	$jhb_city = $cities->getCity($city_id);
    ...
    //get number of rows
    $rowCount = $cities->getPropertyByCityOnShow($city->getCityID(), array('count'=>1));
    
    //initialize pagination class
    $pagConfig = array(
        'baseURL'=> URL.'/northern_cape/on_show_city/'.str_replace('', '_', trim($city->getCityID())).'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
    ...
    //get rows
	$propertyData = $cities->getPropertyByCityOnShow($city->getCityID(), array('limit'=>"$offset,$limit"));
...
<!-- PAGING -->
<link rel="stylesheet" href="<?php echo URL; ?>public/back-office/css/custom.css"/>
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    	<div class="ads-card ads-card-onshow"> 
                        	<h1>Properties on show in <?php echo $city->getCityName(); ?></h1>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                        	...
                        	<!-- CITY TEXT -->
                            <div class="city-text">
                            	<h4>Towns in <?php echo $city->getMunicipality()->getMunicipalityName(); ?></h4>
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                        	...
                        	<!-- CITY TEXT -->
                            <div class="city-text">
                            	<h4>Suburbs in <?php echo $city->getCityName(); ?></h4>
