...
<title>Pixley Ka Isaka Seme</title>
<!--
 ---------------------------------------------------------------
       STYLES
 ---------------------------------------------------------------
    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Pixley Ka Isaka Seme</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getPixleyKaIsakaSemeCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'pixley_ka_isaka_seme/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getPixleyKaIsakaSemeSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'pixley_ka_isaka_seme/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getPixleyKaIsakaSemePropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'pixley_ka_isaka_seme/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'pixley_ka_isaka_seme/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
