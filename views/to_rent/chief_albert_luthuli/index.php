<?php		
	...
	$suburb = new MpumalangaProperty();
	$suburbs = new MpumalangaPropertyDB();
...
<title>Chief Albert Luthuli</title>
<!--
 ---------------------------------------------------------------
       STYLES
 ---------------------------------------------------------------
    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Chief Albert Luthuli</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getChiefAlbertLuthuliCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'chief_albert_luthuli/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getChiefAlbertLuthuliSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'chief_albert_luthuli/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getChiefAlbertLuthuliPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'chief_albert_luthuli/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'chief_albert_luthuli/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
