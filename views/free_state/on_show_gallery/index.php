        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getFreeStateSimilarPropertyOnShow() as $property):
						...
						$subSingleURL = URL.'free_state/on_show_suburb/'.str_replace('', '_', trim($property->getSuburb()->getSuburbID())).'/';
						$citySingleURL = URL.'free_state/on_show_city/'.str_replace('', '_', trim($property->getSuburb()->getCity()->getCityID())).'/';
					?>
