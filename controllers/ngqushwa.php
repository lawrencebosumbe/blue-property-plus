<?php
	class Ngqushwa extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('ngqushwa/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('ngqushwa/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->ngqushwa = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('ngqushwa/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->ngqushwa = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('ngqushwa/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->ngqushwa = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('ngqushwa/to_rent_gallery/index');
		}		
	}
