        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getUphongoloCities($municRow->getMunicipalityID()) as $property):
						...
						$propertySingleURL = URL.'uphongolo/'.'to_rent_city/'.$property->getCityID().'/';
					?>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getUphongoloPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'uphongolo/'.'to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'uphongolo/'.'to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
