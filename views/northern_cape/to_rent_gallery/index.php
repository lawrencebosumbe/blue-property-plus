    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getNorthernCapeSimilarPropertyToRent() as $property):
						...
						$subSingleURL = URL.'northern_cape/to_rent_suburb/'.str_replace('', '_', trim($property->getSuburb()->getSuburbID())).'/';
						$citySingleURL = URL.'northern_cape/to_rent_city/'.str_replace('', '', trim($property->getSuburb()->getCity()->getCityID())).'/';
					?>
