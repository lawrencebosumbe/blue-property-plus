<?php		
	...
	$suburb = new NorthernCapeProperty();
	$suburbs = new NorthernCapePropertyDB();
    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Karoo Hoogland</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getKarooHooglandCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'karoo_hoogland/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getKarooHooglandSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'karoo_hoogland/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getKarooHooglandPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'karoo_hoogland/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'karoo_hoogland/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
