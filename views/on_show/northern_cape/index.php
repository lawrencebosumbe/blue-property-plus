        	...
        	<div class="province-container">
                ...
                <div class="row municipality">
                	...
                	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 municipality-link">
                    	...
                    	<ul> 
                        	<li><a href="<?php echo URL.'on_show/'.$municpSlug; ?>/"><?php echo $municipality->getMunicipalityName(); ?></a></li>
                        </ul>
                    </div>
                     <?php endforeach; ?>
                </div>
                ...
                <div class="row city">       
                	<ul>       
                        <?php foreach($cities->getNorthernCapeCities() as $city): ?> 
                      		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">                               
                               	<li>
                                   <a href="<?php echo URL; ?>on_show/city/<?php echo $city->getCityID();?>">	
                                		<?php echo $city->getCityName(); ?>                                           
                         		   </a>
                             		<span class="num-suburbs">
                                        <?php 
											echo $city->getTotalPropertyOnShow();
										?>
                                     </span>
                                </li>       
                            </div>                                                                               
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getNorthernCapePropertyListImagesOnShow() as $property):
						$municpName = $property->getSuburb()->getCity()->getMunicipality()->getMunicipalityName();
						$municpSlug = str_replace('city of', '', strtolower($municpName));
						$municpSlug = str_replace('city', '', $municpSlug);
						$municpSlug = str_replace(' ', '_', trim($municpSlug));
						$subSinURL = URL.'on_show/'.'suburb/'.$property->getSuburb()->getSuburbID().'/';
						$subrURL = URL.'on_show/'.'city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    	...
                    	<div class="properties item--category-4">
                            ...
                            <div class="list__cat">
                                <span class="label list__cat-label-4">Sales</span>
                                <span class="price">
