                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-8 connectedSortable">                                
                            ...
                            <div class="box box-info">
                                ...
                                <form id="regForm" action="<?php echo URL; ?>back_office/add_province" method="post" 
                                	name="postForm" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">                                                                        
                                        <label for="municipality">Province Details</label>
                                     </div>
                                    <div class="form-group">
                                ...
                                <div class="box-footer clearfix">
                                    <button class="pull-right btn btn-primary" id="btnProvince" type="submit"
                                      name="submit">
                                    	Add Province <i class="fa fa-arrow-circle-right"></i>
                                    </button>
                                </div>
                                </form>
                            </div>
