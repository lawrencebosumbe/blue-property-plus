    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                <h1 style="text-align:center">Lesedi</h1>
                ...
                <!-- ROW -->
                <div class="row municipality"> 
                	<?php foreach($cities->getLesediCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'lesedi/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getLesediSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'lesedi/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getLesediPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'lesedi/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'lesedi/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
