    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getNorthWestSimilarPropertyOnShow() as $property):
						...
						$subSingleURL = URL.'north_west/on_show_suburb/'.str_replace('', '_', trim($property->getSuburb()->getSuburbID())).'/';
						$citySingleURL = URL.'north_west/on_show_city/'.str_replace('', '_', trim($property->getSuburb()->getCity()->getCityID())).'/';
					?>
