    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getIngquzaHillSimilarPropertyToRent() as $property):
						...
						$citySingleURL = URL.'ingquza_hill/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
