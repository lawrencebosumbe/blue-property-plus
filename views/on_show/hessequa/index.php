    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Hessequa</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getHessequaCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'hessequa/'.'on_show_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getHessequaSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'hessequa/'.'on_show_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getHessequaPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'hessequa/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'hessequa/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
