<?php
	class Mtubatuba extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('mtubatuba/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('mtubatuba/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->mtubatuba = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('mtubatuba/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->mtubatuba = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('mtubatuba/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->mtubatuba = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('mtubatuba/to_rent_gallery/index');
		}
	}