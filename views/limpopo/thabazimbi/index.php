    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getThabazimbiCities($municRow->getMunicipalityID()) as $property):
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getThabazimbiSubs($municRow->getMunicipalityID()) as $property):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getThabazimbiPropertyListImagesForSale() as $property):
