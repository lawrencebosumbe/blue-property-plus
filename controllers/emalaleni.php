<?php
	class Emalaleni extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('emalaleni/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('emalaleni/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->emalaleni = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('emalaleni/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->emalaleni = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('emalaleni/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->emalaleni = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('emalaleni/to_rent_gallery/index');
		}
	}