<?php
	class Thembelihle extends Controller{
		...
		public function suburb($suburb_id){
			...
			$this->view->thembelihle = $suburb;
			$this->view->getSuburbImage = $this->model->getSuburbImage($suburb_id);
			if (empty($this->view->thembelihle)) {
				die('This is an invalid suburb!');
			}
										
			$this->view->render('thembelihle/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('thembelihle/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('thembelihle/to_rent_suburb/index');	
		}
		
		//Get single city
		public function city($city_id){
			$this->view->thembelihle = $this->model->getCity($city_id);
			$this->view->getSuburbs = $this->model->getSuburbs();
			if (empty($this->view->thembelihle)) {
			die('This is an invalid city!');
			}
											
			$this->view->render('thembelihle/city');
		}
		
		public function on_show_city($city_id){	
			$city = $this->model->getCity($city_id);
				$this->view->thembelihle = $city;
				$this->view->getSuburbImage = $this->model->getSuburbImage($city_id);
				if (empty($this->view->thembelihle)) {
					die('This is an invalid city!');
				}
			$this->view->render('thembelihle/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('thembelihle/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->thembelihle = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('thembelihle/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->thembelihle = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('thembelihle/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->thembelihle = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('thembelihle/to_rent_gallery/index');
		}
	}