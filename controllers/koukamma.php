<?php
	class koukamma extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('koukamma/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('koukamma/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->koukamma = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('koukamma/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->koukamma = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('koukamma/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->koukamma = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('koukamma/to_rent_gallery/index');
		}			
	}