<?php
	class Sakhisizwe extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('sakhisizwe/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('sakhisizwe/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->sakhisizwe = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('sakhisizwe/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->sakhisizwe = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('sakhisizwe/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->sakhisizwe = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('sakhisizwe/to_rent_gallery/index');
		}		
	}