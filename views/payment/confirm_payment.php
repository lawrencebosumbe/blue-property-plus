                    ...
                    <div class="row">
                        ...
                        <section class="col-md-10 connectedSortable">                                
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
									<div class="payment">
                                    	<img src="<?php echo URL; ?>public/images/payment/card-payment.png"/>
                                    	<p><?php echo 'R ' . $saleListing->getSaleListingAmount(); ?></p>
                                    </div>
                                </div>
                                <!--
                                ...
                                -->
                                <div class="box-footer clearfix">
                                    <a class="pull-right btn btn-success" href="<?php echo URL; ?>payment/pay">
                                    	Confirm Payment <i class="fa fa-arrow-circle-right"></i>
                                    </a>
                                </div>
                                </form>
