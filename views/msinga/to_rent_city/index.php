<?php 
	...
	*/
    ...
    $pagConfig = array(
        'baseURL'=> URL.'/msinga/to_rent_city/'.$city->getCityID().'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'msinga/to_rent_city/'.$town->getCityID(); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'msinga/to_rent_suburb/'.str_replace('', '_', trim($suburb->getSuburbID())); ?>">
											<?php echo $suburb->getSuburbName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
