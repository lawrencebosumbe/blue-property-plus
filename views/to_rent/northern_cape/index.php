<?php 
	...
	$municipalities = new NorthernCapePropertyDB();
	$municipality = new NorthernCapeProperty();
	
	//$municipal = new Municipality();
	//$municipals = new MunicipalityDB();
		
	$city = new NorthernCapeProperty();
	$cities = new NorthernCapePropertyDB();
	
	$property = new NorthernCapeProperty();	
	$properties = new NorthernCapePropertyDB();
	
	//$gauteng_property = new GautengProperty();	
	//$gauteng_properties = new GautengPropertyDB();
...
<!-- GAUTENG -->
<link rel="stylesheet" href="<?php echo URL; ?>public/css1/province-custom.css"/>
...
<body>
    ...
    <div class="banner">               
            ...
            <div style="position:relative;top:0;left:0;width:100%;height:100%;overflow:hidden;">
                ...
                hidden;">
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/top-gauteng.jpg" />              
                    </div>
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/pretoria.jpg" />   
                    </div>
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/johannesburg-3.jpg" />   
                    </div>
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/pretoria-2.jpg" />   
                    </div>
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/johannesburg-4.jpg" />   
                    </div>
                </div>
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Northern Cape</h1>
                ...
                <p>          	 
                    Gauteng is geographically located at 26.2708° South Longitude and 28.1123° East Latitude coordinates. Its
                    climate is cooler and it is found at 1,700 m (5,577 ft) above sea level.
                    Gauteng is the economic hub of South Africa and has the share of lion in South African economy. 
                    It is the host of the African largest Stock Exchange called Johannesburg Stock Exchange (JSE).<br /> 
    
                    Major educational institutions are found in Gauteng. If not all but among the chief are Pretoria University of
                    Technology, University of Johannesburg, University of Pretoria, University of South Africa, University of
                    Witwatersrand, Vaal University of Technology, Monash University South Africa Campus and Midrand Graduate 
                    Institute.
    
                </p>
                
                <h4>By Municipalities</h4>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getNorthernCapeMunicipality($prvRow->getProvinceID()) as $municipality):
						...
						?> 
                	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 municipality-link">
                    	
                    	<ul> 
                        	<li><a href="<?php echo URL.'to_rent/'.$municpSlug; ?>/"><?php echo $municipality->getMunicipalityName(); ?></a></li>
                        </ul>
                    </div>
                     <?php endforeach; ?>
                </div>
                ...
                <h4>By Major Cities</h4>               
                       
                 <?php
					$provinceData = $provinces->getProvinces();
					if(!empty($provinceData)){ foreach($provinceData as $row){
					$provinceName = $row->getProvinceName();
					$provinceSlug = str_replace(' ', '_', strtolower($provinceName));
				?>
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getNorthernCapeCities($row->getProvinceID()) as $city):
						...
						$citySingleURL = URL.$provinceSlug.'/'.'city/'.$city->getCityID().'/';
					?>
                       ...
                       <ul>
                          <li>
                            ...
                            <span class="num-suburbs">
                               <?php 
                                  echo $city->getTotalPropertyToRent();
                               ?>
                         	</span>
                          </li>
                       </ul> 
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getNorthernCapePropertyListImagesToRent() as $property):
						$municpName = $property->getSuburb()->getCity()->getMunicipality()->getMunicipalityName();
						$municpSlug = str_replace('city of', '', strtolower($municpName));
						$municpSlug = str_replace('city', '', $municpSlug);
						$municpSlug = str_replace(' ', '_', trim($municpSlug));
						$subSinURL = URL.$municpSlug.'/'.'suburb/'.$property->getSuburb()->getSuburbID().'/';
						$subrURL = URL.$municpSlug.'/'.'city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
                    
                	<!-- COL -->
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    
                    	<div class="properties item--category-2">
                           ...
                           <div class="listing-title">
                               ...
                               <h4><a href="<?php echo $subSinURL; ?>"><?php echo $property->getPropertyType() . ' in ' . $property->getSuburb()->getSuburbName(); ?></a></h4>
                           </div>
                            <div class="listing__footer">
                               ...
                               <ul>
                                  ...
                                  <li>
                                    ...
                                    <span><a href="<?php echo $subrURL; ?>" class="view-all">viewl all</a></span>
                           </div>
