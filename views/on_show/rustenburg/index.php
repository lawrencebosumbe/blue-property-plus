        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getRustenburgCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'rustenburg/'.'on_show_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getRustenburgSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'rustenburg/'.'on_show_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getRustenburgPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'rustenburg/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'rustenburg/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
