<?php
	class Raymond_Mhlaba extends Controller{
		public function __construct(){
			parent::__construct();
		}	
		
		public function index(){
			$this->view->render('raymond_mhlaba/index');
		}
		
		//Get single suburb
		public function suburb($suburb_id){
			$suburb = $this->model->getSuburb($suburb_id);
			$this->view->raymond_mhlaba = $suburb;
			$this->view->getSuburbImage = $this->model->getSuburbImage($suburb_id);
			if (empty($this->view->raymond_mhlaba)) {
				die('This is an invalid suburb!');
			}
										
			$this->view->render('raymond_mhlaba/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('raymond_mhlaba/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('raymond_mhlaba/to_rent_suburb/index');	
		}
		
		//Get single city
		public function city($city_id){
			$this->view->raymond_mhlaba = $this->model->getCity($city_id);
			$this->view->getSuburbs = $this->model->getSuburbs();
			if (empty($this->view->raymond_mhlaba)) {
			die('This is an invalid city!');
			}
											
			$this->view->render('raymond_mhlaba/city');
		}
		
		public function on_show_city($city_id){	
			$city = $this->model->getCity($city_id);
			$this->view->raymond_mhlaba = $city;
			$this->view->getSuburbImage = $this->model->getSuburbImage($city_id);
			if (empty($this->view->raymond_mhlaba)) {
				die('This is an invalid city!');
			}
			$this->view->render('raymond_mhlaba/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('raymond_mhlaba/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->raymond_mhlaba = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('raymond_mhlaba/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->raymond_mhlaba = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('raymond_mhlaba/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->raymond_mhlaba = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('raymond_mhlaba/to_rent_gallery/index');
		}		
	}