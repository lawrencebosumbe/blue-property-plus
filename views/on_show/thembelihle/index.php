        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getThembelihleCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'thembelihle/'.'on_show_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getThembelihleSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'thembelihle/'.'on_show_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getThembelihlePropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'thembelihle/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'thembelihle/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
