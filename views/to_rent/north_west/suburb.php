<?php 	
    ...
    $pagConfig = array(
        'baseURL'=> URL.'/gauteng/suburb/'.$suburb->getSuburbID().'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
    	...
    	<div class="container">
            ...
            <!-- END ROW -->			
				...
				<div class="row">
            		...
            		<!-- COL -->
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    	<div class="ads-card-torent"> 
                        	<h1>Properties to rent in <?php echo $suburb->getSuburbName(); //echo $suburb->getCity()->getCityName(); ?></h1>
                        ...
                        <div class="card">                            	
                            ...
                            <div class="card-img item--category-1">
                                <figure>
                                    <a href="<?php echo URL; ?>gauteng/gallery/<?php echo $suburb->getPropertyID(); ?>">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'gauteng/city/'.$town->getCityID(); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                        	...
                        	<!-- CITY TEXT -->
                            <div class="city-text">
                            	<h4>Municipalities in Gauteng</h4>
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'gauteng/suburb/'.str_replace('', '_', trim($suburb->getSuburbID())); ?>">
											<?php echo $suburb->getSuburbName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
