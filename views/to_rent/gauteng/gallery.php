...
<!--
 ---------------------------------------------------------------
       STYLES
 ---------------------------------------------------------------
 NOTE: Never reference Bootstrap v3 and v4 in the same file because
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="position-relative galleryTrigger item--category-1">
                  ...
                  <div class="stat-data row pt-3">
                    ...
                    <ul class="list-unstyled col-sm-4 col-6">
                     ...
                     <ul class="list-unstyled col-sm-4 col-6">
                          ...
                          <li><span class="badge badge-light big-badge"><?php echo $propertyAC; ?></span>  Air Conditionning</li>
                          <li><span class="badge-type"><i class="glyphicon glyphicon-ok green"></i></span>Play groung for kids</li>
                     </ul>
                  </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <aside class="banner-add d-flex flex-column justify-content-center align-items-center">
                  ...
                  <div class="pt-5">
                      House in <?php echo $suburb->getSuburbName(); ?> 
                    </div>
               </aside>
               <aside class="contact-agent mt-3">
                  ...
                  <form>
                      ...
                      <div class="form-group">
                      <button type="submit" class="btn btn-orange btn-block" name="submit">Email Agent</button>
    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
					<?php foreach($gauteng_properties->getGautengSimilarPropertyForSale() as $gauteng_property):
						$municpName = $gauteng_property->getSuburb()->getCity()->getMunicipality()->getMunicipalityName();
						...
						$subSingleURL = URL.$municpSlug.'/'.'suburb/'.$gauteng_property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.$municpSlug.'/'.'city/'.$gauteng_property->getSuburb()->getCity()->getCityID().'/';
					?>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    	...
                    	<div class="properties item--category-1">
                            ...
                            <figure class="image-holder">
                                <img src="<?php echo URL; ?><?php echo $gauteng_property->getImageLocation(); ?>"
                                alt="<?php echo $gauteng_property->getImageAltText(); ?>"/>                      
                            </figure>
							</a>
                            <div class="list__cat">
                                <span class="label list__cat-label-1">Sales</span>
                                <span class="price">
                                    <?php echo 'R ' . substr($gauteng_property->getPrice(), 0, 1) . ', '
                                                    . substr($gauteng_property->getPrice(), 1, 3) . ', '
                                                    . substr($gauteng_property->getPrice(), 4, 3) 
                                    ; ?>
                                </span>                                    
                           </div>
                           <div class="listing-title">
                               <a href="#" class="listing__plus"></a>
                               <h4><a href="<?php echo $subSingleURL; ?>"><?php echo $gauteng_property->getPropertyType() . ' in ' . $gauteng_property->getSuburb()->getSuburbName(); ?></a></h4>
                           </div>
                            <div class="listing__footer">
                               <figure>
                                  <img src="<?php echo URL; ?><?php  echo $gauteng_property->getAgent()->getAgency()->getLogo(); ?>"/>
                               </figure>
                               <ul>
                                   <li>
                                        <span><?php  echo $gauteng_property->getNumBed(); ?></span>
                           	            <img src="<?php echo URL; ?>public/images/properties/icons/icon-bed.png"/>
                                  </li>
                                  <li>
                                        <span><?php echo $gauteng_property->getNumBathRoom(); ?></span>
                                        <img src="<?php echo URL; ?>public/images/properties/icons/icon-bath.png"/>
                                  </li>
                                  <li>
                                        <span><?php echo $gauteng_property->getNumGarage(); ?></span>
	...
	<!--
       ...
       <script src="<?php echo URL; ?>public/carousel-slider/script.js"></script>
        ...
        <!--<script src="<?php echo URL; ?>public/lightgallery/js/jquery.min.js"></script>-->
