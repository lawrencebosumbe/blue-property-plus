    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Property in Amahlathi</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getAmahlathiCities($municRow->getMunicipalityID()) as $city):
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getAmahlathiSubs($municRow->getMunicipalityID()) as $suburb):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getAmahlathiPropertyListImagesForSale() as $property):
