                        ...
                        <section class="col-lg-12 connectedSortable">  
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Listing of Cities</h3>
                                </div>
                                <div class="box-body">
                                    <table class='table table-hover table-responsive table-striped table-advance' width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($cities->getRecords($from_record_num, $records_per_page) as $city): ?>
                                            	<tr>
                                                	<td width="5%"><?php echo $city->getCityID();?></td>
                                                    <td width="10%"><?php echo $city->getCityCode();?></td>
                                                    <td width="20%"><?php echo $city->getCityName();?></td>
                                                    <td width="10%"><?php echo $city->getTotalPropertyForSale();?></td>
                                                    <td width="10%"><?php echo $city->getTotalPropertyToRent();?></td>
                                                    <td width="10%"><?php echo $city->getTotalPropertyOnShow();?></td>
                                                    <td width="45%">
                                                    	<a class="pull-right btn btn-danger delete" 
                                                          href="<?php echo URL; ?>property_city/deleteCity/<?php echo $city->
														  getCityID();?>">
                                                          <span class="glyphicon glyphicon-trash"> Delete </span>
                                                        </a>                                                    	
                                                        <a class="pull-right btn btn-info" 
                                                          href="<?php echo URL; ?>property_city/city_edit/<?php echo $city->
														  getCityID();?>">
                                                          <span class="glyphicon glyphicon-edit"> Update </span>
                                                        </a>
                                                        <a class="pull-right btn btn-primary" 
                                                          href="<?php echo URL; ?>property_city/city_single/<?php echo $city->
														  getCityID();?>">
