<?php 
	...
	$municipalities = new WesternCapePropertyDB();
	$municipality = new WesternCapeProperty();
		
	$city = new WesternCapeProperty();
	$cities = new WesternCapePropertyDB();
	
	$property = new WesternCapeProperty();	
	$properties = new WesternCapePropertyDB();
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Western Cape</h1>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getWesternCapeMunicipality($prvRow->getProvinceID()) as $municipality):
                ...
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getWesternCapeCities($row->getProvinceID()) as $city):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getWesternCapePropertyListImagesForSale() as $property):
