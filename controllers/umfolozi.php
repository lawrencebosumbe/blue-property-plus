<?php
	class Umfolozi extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('umfolozi/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('umfolozi/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->umfolozi = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('umfolozi/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->umfolozi = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('umfolozi/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->umfolozi = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('umfolozi/to_rent_gallery/index');
		}
	}