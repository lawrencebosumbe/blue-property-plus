<?php
	class Nkonkobe extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('nkonkobe/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('nkonkobe/to_rent_suburb/index');	
		}
		
		//Get single city
		public function city($city_id){
			$this->view->nkonkobe = $this->model->getCity($city_id);
			$this->view->getSuburbs = $this->model->getSuburbs();
			if (empty($this->view->nkonkobe)) {
			die('This is an invalid city!');
			}
											
			$this->view->render('nkonkobe/city');
		}
		...
		public function on_show_gallery($property_id){
			$this->view->nkonkobe = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('nkonkobe/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->nkonkobe = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('nkonkobe/to_rent_gallery/index');
		}		
	}