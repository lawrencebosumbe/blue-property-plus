<?php
	class Moses_Kotane extends Controller{
		...
		public function suburb($suburb_id){
			...
			$this->view->moses_kotane = $suburb;
			$this->view->getSuburbImage = $this->model->getSuburbImage($suburb_id);
			if (empty($this->view->moses_kotane)) {
				die('This is an invalid suburb!');
			}
										
			$this->view->render('moses_kotane/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('moses_kotane/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('moses_kotane/to_rent_suburb/index');	
		}
		
		//Get single city
		public function city($city_id){
			$this->view->moses_kotane = $this->model->getCity($city_id);
			$this->view->getSuburbs = $this->model->getSuburbs();
			if (empty($this->view->moses_kotane)) {
			die('This is an invalid city!');
			}
											
			$this->view->render('moses_kotane/city');
		}
		
		public function on_show_city($city_id){	
			$city = $this->model->getCity($city_id);
				$this->view->moses_kotane = $city;
				$this->view->getSuburbImage = $this->model->getSuburbImage($city_id);
				if (empty($this->view->moses_kotane)) {
					die('This is an invalid city!');
				}
			$this->view->render('moses_kotane/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('moses_kotane/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->moses_kotane = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('moses_kotane/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->moses_kotane = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('moses_kotane/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->moses_kotane = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('moses_kotane/to_rent_gallery/index');
		}
	}