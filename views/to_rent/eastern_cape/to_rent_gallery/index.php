    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="position-relative galleryTrigger item--category-2">
    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getGautengSimilarPropertyToRent() as $gauteng_property):
						...
						$subSingleURL = URL.'gauteng/to_rent_suburb/'.$gauteng_property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'gauteng/to_rent_city/'.$gauteng_property->getSuburb()->getCity()->getCityID().'/';
					?>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    	...
                    	<div class="properties item--category-2">
                            ...
                            <div class="list__cat">
                                <span class="label list__cat-label-2">ToRent</span>
                                <span class="price">
