<?php 
	...
	$city = new EasternCapeProperty();
	$cities = new EasternCapePropertyDB();
	
	$property = new EasternCapeProperty();	
	$properties = new EasternCapePropertyDB();
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Eastern Cape</h1>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getEasternCapeMunicipality($prvRow->getProvinceID()) as $municipality):
                ...
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getEasternCapeCities($row->getProvinceID()) as $city):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getEasternCapePropertyListImagesToRent() as $property):
