        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getNkosazanaDlaminiZumaCities($municRow->getMunicipalityID()) as $property):
						...
						$propertySingleURL = URL.'nkosazana_dlamini_zuma/'.'on_show_city/'.$property->getCityID().'/';
					?>
                       ...
                       <ul>
                          <li>
                            ...
                            <span class="num-suburbs">
                               <?php 
                                  echo $property->getTotalPropertyOnShow();
                               ?>
                         	</span>
                          </li>
                       </ul> 
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getNkosazanaDlaminiZumaSubs($municRow->getMunicipalityID()) as $property):
						...
						$propertySlug = str_replace('city', '', $propertySlug);
						$propertySlug = str_replace(' ', '_', trim($propertySlug));
						$propertySingleURL = URL.'nkosazana_dlamini_zuma/'.'on_show_suburb/'.$property->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getNkosazanaDlaminiZumaPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'nkosazana_dlamini_zuma/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'nkosazana_dlamini_zuma/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
