    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Property in Nkonkobe</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getNkonkobeCities($municRow->getMunicipalityID()) as $city):
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getNkonkobeSubs($municRow->getMunicipalityID()) as $suburb):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getNkonkobePropertyListImagesForSale() as $property):
