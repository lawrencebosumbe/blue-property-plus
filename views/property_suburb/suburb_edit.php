                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-10 connectedSortable">  
                            ...
                            <div class="box box-info">
                                ...
                                <form action="<?php echo URL; ?>property_suburb/updateSuburb/<?php echo $suburb->getSuburbID();?>"
                                ...
                                <div class="box-body">        							
                                          ...
                                          <tr>
                                             ...
                                             <td width="15%">
                                                 <div class="form-group">
                                                 	<input type="hidden" value="<?php echo $suburb->getSuburbID();?>" name="suburb_id" />
                                                    <input type="text" value="<?php echo $suburb->getSuburbCode();?>" name="code" />
                                                 </div>														
                                             </td>
                                             <td width="35%">
                                                 <div class="form-group">
                                                    <input type="text" value="<?php echo $suburb->getSuburbName();?>" name="name" />
                                                 </div>														
                                             </td>
                                          </tr>
                                       </tbody>
                                    ...
                                    <button class="pull-right btn btn-info" type="submit">
                                    	<span class="glyphicon glyphicon-edit"> Update Suburb </span>
                                    </button> 
                                </div>         							
                                </div>
                                </form>
