        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getNkosazanaDlaminiZumaCities($municRow->getMunicipalityID()) as $property):
						...
						$citySingleURL = URL.$municipalitySlug.'/'.'city/'.$property->getCityID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
                          	<a href="<?php echo $citySingleURL; ?>"><?php echo $property->getCityName(); ?></a>
                            <span class="num-suburbs">
                               <?php 
                                  echo $property->getTotalPropertyForSale();
                               ?>
                         	</span>
                          </li>
                       </ul> 
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getNkosazanaDlaminiZumaSubs($municRow->getMunicipalityID()) as $property):
						...
						$suburbSingleURL = URL.$municipalitySlug.'/'.'suburb/'.$property->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
                          	<a href="<?php echo $suburbSingleURL; ?>"><?php echo $property->getSuburbName(); ?></a>
                            <span class="num-suburbs">
                               <?php 
                                  echo $property->getTotalPropertyForSale();
                               ?>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getNkosazanaDlaminiZumaPropertyListImagesForSale() as $property):
