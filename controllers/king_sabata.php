<?php
	class King_Sabata extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('king_sabata/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('king_sabata/to_rent_suburb/index');	
		}
		
		//Get single city
		public function city($city_id){
			$this->view->king_sabata = $this->model->getCity($city_id);
			$this->view->getSuburbs = $this->model->getSuburbs();
			if (empty($this->view->king_sabata)) {
			die('This is an invalid city!');
			}
											
			$this->view->render('king_sabata/city');
		}
		
		public function on_show_city($city_id){	
			$city = $this->model->getCity($city_id);
			$this->view->king_sabata = $city;
			$this->view->getSuburbImage = $this->model->getSuburbImage($city_id);
			if (empty($this->view->king_sabata)) {
				die('This is an invalid city!');
			}
			$this->view->render('king_sabata/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('king_sabata/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->king_sabata = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('king_sabata/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->king_sabata = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('king_sabata/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->king_sabata = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('king_sabata/to_rent_gallery/index');
		}		
	}