<?php		
	...
	$suburb = new NorthWestProperty();
	$suburbs = new NorthWestPropertyDB();
    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Ramotshere Moiloa</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getRamotshereMoiloaCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'ramotshere_moiloa/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getRamotshereMoiloaSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'ramotshere_moiloa/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getRamotshereMoiloaPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'ramotshere_moiloa/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'ramotshere_moiloa/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
