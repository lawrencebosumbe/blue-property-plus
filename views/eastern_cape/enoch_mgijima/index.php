    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Property in Enoch Mgijima</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getEnochMgijimaCities($municRow->getMunicipalityID()) as $city):
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getEnochMgijimaSubs($municRow->getMunicipalityID()) as $suburb):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getEnochMgijimaPropertyListImagesForSale() as $property):
