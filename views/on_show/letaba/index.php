        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getLetabaCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'letaba/'.'on_show_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getLetabaSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'letaba/'.'on_show_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getLetabaPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'letaba/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'letaba/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
