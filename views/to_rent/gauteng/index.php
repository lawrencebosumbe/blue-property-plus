    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Gauteng</h1>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getGautengMunicipality($prvRow->getProvinceID()) as $municipality):
                ...
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getGautengCities($row->getProvinceID()) as $city):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getPropertyListImagesToRent() as $property):
