<?php 	
    ...
    $pagConfig = array(
        'baseURL'=> URL.'engcobo/on_show_suburb/'.$suburb->getSuburbID().'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'engcobo/on_show_city/'.$town->getCityID(); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'eastern_city/'.str_replace(' ', '_', trim($municipality->getMunicipalityName())); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'engcobo/on_show_suburb/'.str_replace('', '_', trim($suburb->getSuburbID())); ?>">
											<?php echo $suburb->getSuburbName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
