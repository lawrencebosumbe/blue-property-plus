<?php 
	...
	$municipalities = new LimpopoPropertyDB();
	$municipality = new LimpopoProperty();
	
	//$municipal = new Municipality();
	//$municipals = new MunicipalityDB();
		
	$city = new LimpopoProperty();
	$cities = new LimpopoPropertyDB();
	
	$property = new LimpopoProperty();	
	$properties = new LimpopoPropertyDB();
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Limpopo</h1>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getLimpopoMunicipality($prvRow->getProvinceID()) as $municipality):
                ...
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getLimpopoCities($row->getProvinceID()) as $city):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getLimpopoPropertyListImagesToRent() as $property):
