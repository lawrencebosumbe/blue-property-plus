    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Property in Sakhisizwe</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getSakhisizweCities($municRow->getMunicipalityID()) as $city):
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getSakhisizweSubs($municRow->getMunicipalityID()) as $suburb):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getSakhisizwePropertyListImagesForSale() as $property):
