<?php
	class Okhahlamba extends Controller{
		...
		public function suburb($suburb_id){
			...
			$this->view->okhahlamba = $suburb;
			$this->view->getSuburbImage = $this->model->getSuburbImage($suburb_id);
			if (empty($this->view->okhahlamba)) {
				die('This is an invalid suburb!');
			}
										
			$this->view->render('okhahlamba/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('okhahlamba/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('okhahlamba/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->okhahlamba = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('okhahlamba/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->okhahlamba = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('okhahlamba/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->okhahlamba = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('okhahlamba/to_rent_gallery/index');
		}
	}