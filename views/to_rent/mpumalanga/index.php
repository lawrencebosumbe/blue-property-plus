<?php 
	...
	$municipalities = new MpumalangaPropertyDB();
	$municipality = new MpumalangaProperty();
	
	//$municipal = new Municipality();
	//$municipals = new MunicipalityDB();
		
	$city = new MpumalangaProperty();
	$cities = new MpumalangaPropertyDB();
	
	$property = new MpumalangaProperty();	
	$properties = new MpumalangaPropertyDB();
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Mpumalanga</h1>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getMpumalangaMunicipality($prvRow->getProvinceID()) as $municipality):
                ...
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getMpumalangaCities($row->getProvinceID()) as $city):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getMpumalangaPropertyListImagesToRent() as $property):
