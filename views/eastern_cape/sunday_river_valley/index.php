<?php		
	...
	$suburb = new EasternCapeProperty();
	$suburbs = new EasternCapePropertyDB();
    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Property in Sunday River Valley</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getSundayRiverValleyCities($municRow->getMunicipalityID()) as $city):
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getSundayRiverValleySubs($municRow->getMunicipalityID()) as $suburb):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getSundayRiverValleyPropertyListImagesForSale() as $property):
