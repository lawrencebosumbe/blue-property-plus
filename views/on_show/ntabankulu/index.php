    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Ntabankulu</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getNtabankuluCities($municRow->getMunicipalityID()) as $property):
						...
						$propertySingleURL = URL.'ntabankulu/'.'on_show_city/'.$property->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getNtabankuluSubs($municRow->getMunicipalityID()) as $property):
						$propertyName = $property->getSuburbName();
						$propertySlug = str_replace('city of', '', strtolower($propertyName));
						$propertySlug = str_replace('city', '', $propertySlug);
						$propertySlug = str_replace(' ', '_', trim($propertySlug));
						$propertySingleURL = URL.'ntabankulu/'.'on_show_suburb/'.$property->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getNtabankuluPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'ntabankulu/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'ntabankulu/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
