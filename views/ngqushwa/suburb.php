<?php 	
	...
	$municipality_id = isset($_GET['municipality_id']) ? $_GET['municipality_id'] : "34";
    ...
    $pagConfig = array(
        'baseURL'=> URL.'/ngqushwa/suburb/'.$suburb->getSuburbID().'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="card">                            	
                            ...
                            <div class="card-img item--category-1">
                                <figure>
                                    <a href="<?php echo URL; ?>ngqushwa/gallery/<?php echo $suburb->getPropertyID(); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'ngqushwa/city/'.$town->getCityID(); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'ngqushwa/suburb/'.str_replace('', '_', trim($suburb->getSuburbID())); ?>">
											<?php echo $suburb->getSuburbName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
