<?php		
	...
	$suburb = new LimpopoProperty();
	$suburbs = new LimpopoPropertyDB();
    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Elias Motsoaledi</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getEliasMotsoalediCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'elias_motsoaledi/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getEliasMotsoalediSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'elias_motsoaledi/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getEliasMotsoalediPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'elias_motsoaledi/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'elias_motsoaledi/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
