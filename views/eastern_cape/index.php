       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getEasternCapePropertyListImagesForSale() as $property):
						$municpName = $property->getSuburb()->getCity()->getMunicipality()->getMunicipalityName();
						$municpSlug = str_replace('city of', '', strtolower($municpName));
						$municpSlug = str_replace('city', '', $municpSlug);
						$municpSlug = str_replace(' ', '_', trim($municpSlug));
						$subSinURL = URL.$municpSlug.'/'.'suburb_forsale/'.$property->getSuburb()->getSuburbID().'/';
						$subrURL = URL.$municpSlug.'/'.'city_forsale/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
