<?php
	class Dihlabeng extends Controller{
		...
		public function suburb($suburb_id){
			...
			$this->view->render('dihlabeng/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('dihlabeng/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('dihlabeng/to_rent_suburb/index');	
		}
		...
		public function city($city_id){
			...
			$this->view->render('dihlabeng/city');
		}
		...
		public function on_show_city($city_id){	
			...
			$this->view->render('dihlabeng/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('dihlabeng/to_rent_city/index');	
		}
		...
		public function gallery($property_id){
			...
			$this->view->render('dihlabeng/gallery');
		}
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('dihlabeng/on_show_gallery/index');
		}
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('dihlabeng/to_rent_gallery/index');
		}
	}