<?php
	class Makana extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('makana/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('makana/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->makana = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('makana/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->makana = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('makana/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->makana = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('makana/to_rent_gallery/index');
		}		
	}
