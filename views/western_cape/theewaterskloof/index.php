    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getTheewaterskloofCities($municRow->getMunicipalityID()) as $property):
						$cityName = $property->getCityName();
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getTheewaterskloofSubs($municRow->getMunicipalityID()) as $property):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getTheewaterskloofPropertyListImagesForSale() as $property):
