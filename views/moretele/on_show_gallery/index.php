    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getMoreteleSimilarPropertyOnShow() as $property):
						...
						$subSingleURL = URL.'moretele/on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'moretele/on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
