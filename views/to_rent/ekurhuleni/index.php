...
<body>
    ...
    <div class="banner">               
            ...
            <div style="position:relative;top:0;left:0;width:100%;height:100%;overflow:hidden;">
                ...
                hidden;">
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/eku-slide-1.jpg" />              
                    </div>
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/eku-slide-2.jpg" />   
                    </div>
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/eku-slide-3.jpg" />   
                    </div>
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/eku-slide-4.jpg" />   
                    </div>
                    <div data-p="200.00">
                        <img data-u="image" src="<?php echo URL; ?>public/images/properties/gauteng/eku-slide-5.jpg" />   
                    </div>
                </div>
    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                <h1 style="text-align:center">Ekurhuleni</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getEkurhuleniCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'ekurhuleni/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getEkurhuleniSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'ekurhuleni/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getEkurhuleniPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'ekurhuleni/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'ekurhuleni/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
