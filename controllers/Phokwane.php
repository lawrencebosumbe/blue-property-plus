<?php
	class Phokwane extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('phokwane/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('phokwane/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->phokwane = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('phokwane/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->phokwane = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('phokwane/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->phokwane = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('phokwane/to_rent_gallery/index');
		}
	}