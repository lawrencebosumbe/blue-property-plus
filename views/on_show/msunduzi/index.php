        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getMsunduziCities($municRow->getMunicipalityID()) as $property):
						...
						$propertySingleURL = URL.'msunduzii/'.'on_show_city/'.$property->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getMsunduziSubs($municRow->getMunicipalityID()) as $property):
						...
						$propertySlug = str_replace('city', '', $propertySlug);
						$propertySlug = str_replace(' ', '_', trim($propertySlug));
						$propertySingleURL = URL.'msunduzi/'.'on_show_suburb/'.$property->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getMsunduziPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'msunduzi/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'msunduzi/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
