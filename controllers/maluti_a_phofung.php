<?php
	class Maluti_A_phofung extends Controller{
		...
		public function suburb($suburb_id){
			...
			$this->view->render('maluti_a_phofung/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('maluti_a_phofung/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('maluti_a_phofung/to_rent_suburb/index');	
		}
		...
		public function city($city_id){
			...
			$this->view->render('maluti_a_phofung/city');
		}
		...
		public function on_show_city($city_id){	
			...
			$this->view->render('maluti_a_phofung/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('maluti_a_phofung/to_rent_city/index');	
		}
		...
		public function gallery($property_id){
			...
			$this->view->render('maluti_a_phofung/gallery');
		}
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('maluti_a_phofung/on_show_gallery/index');
		}
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('maluti_a_phofung/to_rent_gallery/index');
		}
	}