<?php 
	...
	*/
    ...
    $pagConfig = array(
        'baseURL'=> URL.'/kwazulu_natal/to_rent_city/'.str_replace('', '_', trim($city->getCityID())).'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'kwazulu_natal/to_rent_city/'.str_replace('', '_', trim($town->getCityID())); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'kwazulu_natal/to_rent_suburb/'.str_replace('', '_', trim($suburb->getSuburbID())); ?>">
											<?php echo $suburb->getSuburbName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
