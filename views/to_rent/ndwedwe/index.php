        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getNdwedweCities($municRow->getMunicipalityID()) as $property):
						...
						$propertySingleURL = URL.'ndwedwe/'.'to_rent_city/'.$property->getCityID().'/';
					?>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getNdwedwePropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'ndwedwe/'.'to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'ndwedwei/'.'to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
