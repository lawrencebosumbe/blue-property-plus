<?php
	class Nyandeni extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('nyandeni/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('nyandeni/to_rent_suburb/index');	
		}
		
		//Get single city
		public function city($city_id){
			$this->view->nyandeni = $this->model->getCity($city_id);
			$this->view->getSuburbs = $this->model->getSuburbs();
			if (empty($this->view->nyandeni)) {
			die('This is an invalid city!');
			}
											
			$this->view->render('nyandeni/city');
		}
		
		public function on_show_city($city_id){	
			$city = $this->model->getCity($city_id);
			$this->view->nyandeni = $city;
			$this->view->getSuburbImage = $this->model->getSuburbImage($city_id);
			if (empty($this->view->nyandeni)) {
				die('This is an invalid city!');
			}
			$this->view->render('nyandeni/on_show_city/index');	
		}
		
		public function to_rent_city($city_id){	
			$city = $this->model->getCity($city_id);
			$this->view->nkonkobe = $city;
			$this->view->getSuburbImage = $this->model->getSuburbImage($city_id);
			if (empty($this->view->nkonkobe)) {
					die('This is an invalid city!');
			}
			$this->view->render('nkonkobe/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->nkonkobe = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('nkonkobe/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->nyandeni = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('nyandeni/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->nyandeni = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('nyandeni/to_rent_gallery/index');
		}		
	}