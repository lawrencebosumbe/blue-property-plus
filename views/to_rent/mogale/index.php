    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                <h1 style="text-align:center">Mogale City</h1>
                ...
                <!-- ROW -->
                <div class="row municipality"> 
                	<?php foreach($cities->getMogaleCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'mogale/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getMogaleSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'mogale/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getMogalePropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'mogale/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'mogale/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
                            ...
                            <div class="blue-bottom-border">
                                <a href="#">
                                    <figure class="user-post">
                                    	<img src="../public/images/<?php //echo $post->getEmployee()->getImage(); ?>"/>
                                    </figure>
                                    <span>
										<?php //echo $post->getEmployee()->getFirstname() . ' ' .
												   //$post->getEmployee()->getLastname();
										 ?>
                                    </span>                                 
                                </a>
