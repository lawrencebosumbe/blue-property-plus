<?php
	class Pretoria extends Controller{
		private $city_name;
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('pretoria/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('pretoria/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->pretoria = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('pretoria/gallery');
		}	
		...
		$this->view->pretoria = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('pretoria/to_rent_gallery/index');
		}
	}