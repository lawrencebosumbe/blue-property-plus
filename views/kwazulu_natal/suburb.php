<?php 	
	...
	$province_id = isset($_GET['province_id']) ? $_GET['province_id'] : "4";		
    ...
    //get number of rows
    $rowCount = $suburbs->getPropertyBySuburbForSale($suburb->getSuburbID(), array('count'=>1));
    
    //initialize pagination class
    $pagConfig = array(
        'baseURL'=> URL.'/kwazulu_natal/suburb/'.str_replace('', '_', trim($suburb->getSuburbID())).'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
    ...
    //get rows
	$propertyData = $suburbs->getPropertyBySuburbForSale($suburb->getSuburbID(), array('limit'=>"$offset,$limit"));
	 ...
	 */
	 /*
	$suburbLimit = 15;
	$suburbRowCount = $suburbs->getMunicipalitySuburbs($municipality_id, array('count'=>1));
	$suburbData = $suburbs->getMunicipalitySuburbs($municipality_id);
	*/
	$suburbLimit = 15;
...
<title><?php echo $city->getCityName(); ?></title>
<!--
 ---------------------------------------------------------------
       STYLES
 ---------------------------------------------------------------
    	...
    	<div class="container">
            ...
            <!-- END ROW -->			
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    	<div class="ads-card"> 
                        	<h1>Properties for sale in <?php echo $suburb->getSuburbName(); //echo $suburb->getCity()->getCityName(); ?></h1>
                        ...
                        <div class="card">                            	
                        	<!-- CARD IMAGE -->
                            <div class="card-img item--category-1">
                                <figure>
                                    <a href="<?php echo URL; ?>kwazulu_natal/gallery/<?php echo $suburb->getPropertyID(); ?>">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'kwazulu_natal/city/'.$town->getCityID(); ?>">
											<?php echo $town->getCityName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
                                                  echo $town->getTotalPropertyForSale();
                                               ?>
                                        </span>
                                    </li>
									<?php
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                <?php foreach($properties->getPropertyAdForSale() as $property):
									...
									$municpSlug = str_replace('city', '', $municpSlug);
									$municpSlug = str_replace(' ', '_', trim($municpSlug));
									$subSinURL = URL.$municpSlug.'/'.'suburb/'.str_replace('', '_', trim($property->suburb_id)).'/';
									$subrURL = URL.$municpSlug.'/'.'city/'.str_replace('', '_', trim($property->city_id)).'/';
								?>                               
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                        	...
                        	<!-- CITY TEXT -->
                            <div class="city-text">
                            	<h4>Municipalities in Kwazulu Natal</h4>
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'kwazulu_natal/'.str_replace(' ', '_', trim($municipality->getMunicipalityName())); ?>">
											<?php echo $municipality->getMunicipalityName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
                                                  echo $municipality->getTotalPropertyForSale();
                                               ?>
                                        </span>
                                    </li>
									<?php
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'kwazulu_natal/suburb/'.str_replace('', '_', trim($suburb->getSuburbID())); ?>">
											<?php echo $suburb->getSuburbName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
