    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getGautengSimilarPropertyOnShow() as $gauteng_property):
						...
						$subSingleURL = URL.'gauteng/on_show_suburb/'.$gauteng_property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'gauteng/on_show_city/'.$gauteng_property->getSuburb()->getCity()->getCityID().'/';
					?>
