<?php 	
	$province_id = isset($_GET['province_id']) ? $_GET['province_id'] : "9";		
	//$municipality_id = isset($_GET['municipality_id']) ? $_GET['municipality_id'] : "2";
	
	$municipality = new NorthernCapeMunicipality();
	$municipalities = new NorthernCapeDB();
	
	$suburbs = new SuburbDB();
	$suburb = new Suburb();
	$suburb = $this->northern_cape;
    ...
    //get number of rows
    $rowCount = $suburbs->getPropertyBySuburbOnShow($suburb->getSuburbID(), array('count'=>1));
    
    //initialize pagination class
    $pagConfig = array(
        'baseURL'=> URL.'northern_cape/on_show_suburb/'.str_replace('', '_', trim($suburb->getSuburbID())).'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
    ...
    //get rows
	$propertyData = $suburbs->getPropertyBySuburbOnShow($suburb->getSuburbID(), array('limit'=>"$offset,$limit"));
	 ...
	 */
	$suburbLimit = 15;
	$suburbRowCount = $suburbs->getCitySuburbs($suburb->getCity()->getCityID(), array('count'=>1));
	$suburbData = $suburbs->getCitySuburbs($suburb->getCity()->getCityID());
               ...
               <li>
                ...
                data-content="
                	<ul>
                        ...
                        <li>
                        	<a href='<?php echo URL; ?>signup/'>Register your property</a> 
        	...
        	<div class="single-city-listing">			
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    	<div class="ads-card ads-card-onshow"> 
                        	<h1>Properties on show in <?php echo $suburb->getSuburbName(); ?></h1>
                        	<p>Central, Town and Suburbs</p>
                            <?php foreach($properties->getPropertyAdOnShow() as $property):
                        ...
                        <div class="card">                            	
                        	<!-- CARD IMAGE -->
                            <div class="card-img item--category-4">
                                <figure>
                                    <a href="<?php echo URL; ?>northern_cape/gallery/<?php echo $suburb->getPropertyID(); ?>">
                            	...
                            	<!-- SECTION HEADER -->
                            	 <div class="card-header">
                                  ...
                                  <div class="card-body">
                                    <ul> 
                                    	<li>
											<?php echo substr($suburb->getPrice(), 0, 1) . ', '
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                        	...
                        	<!-- CITY TEXT -->
                            <div class="city-text">
                            	<h4>Towns in <?php echo $suburb->getCity()->getMunicipality()->getMunicipalityName(); ?></h4>
                                
                                <!-- LIST OF ALL CITIES HERE -->                                
                                <ul>
									<?php if(!empty($cityData)): $ci=0; foreach($cityData as $town): $ci++;?>
									<li>
                                    	<a href="<?php echo URL.'northern_cape/on_show_city/'.str_replace('', '_', trim($town->getCityID())); ?>">
											<?php echo $town->getCityName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
                                                  echo $town->getTotalPropertyOnShow();
                                               ?>
                                        </span>
                                    </li>
									<?php
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                <?php foreach($properties->getPropertyAdOnShow() as $property):
									...
									$municpSlug = str_replace('city', '', $municpSlug);
									$municpSlug = str_replace(' ', '_', trim($municpSlug));
									$subSinURL = URL.$municpSlug.'/'.'on_show_suburb/'.$property->suburb_id.'/';
									$subrURL = URL.$municpSlug.'/'.'on_show_city/'.$property->city_id.'/';
								?>                               
                                     ...
                                     <a href="<?php echo $subSinURL; ?>">
                                      ...
                                      <div class="listing__footer">
                                          ...
                                          <img src="<?php echo URL; ?><?php  echo $property->getAgent()->getAgency()->getLogo(); ?>"/>
                                              ...
                                              <li>
                                                 <!--<a href="<?php //echo $subrURL; ?>">viewl all</a>-->
                                              </li>
                                         </ul>
                                      </div>
                               </div> 
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                        	...
                        	<!-- CITY TEXT -->
                            <div class="city-text">
                            	<h4>Municipalities in Northern Cape</h4>
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'northern_cape/'.str_replace(' ', '_', trim($municipality->getMunicipalityName())); ?>">
											<?php echo $municipality->getMunicipalityName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
                                                  echo $municipality->getTotalPropertyOnShow();
                                               ?>
                                        </span>
                                    </li>
									<?php
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                        	...
                        	<!-- CITY TEXT -->
                            <div class="city-text">
                            	<h4>Suburbs in <?php echo $suburb->getCity()->getCityName(); ?></h4>
                                
                                <!-- LIST OF ALL CITIES HERE -->                                
                                <ul>
									<?php if(!empty($suburbData)): $si=0; foreach($suburbData as $suburb): $si++;?>
									<li>
                                    	<a href="<?php echo URL.'northern_cape/on_show_suburb/'.str_replace('', '_', trim($suburb->getSuburbID())); ?>">
											<?php echo $suburb->getSuburbName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
                                                  echo $suburb->getTotalPropertyOnShow();
                                               ?>
                                        </span>
                                    </li>
									<?php
