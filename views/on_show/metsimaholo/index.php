    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Metsimaholo</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getMetsimaholoCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'metsimaholo/'.'on_show_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getMetsimaholoSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'metsimaholo/'.'on_show_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getMetsimaholoPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'metsimaholo/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'metsimaholo/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    	...
                    	<div class="properties item--category-2">
                            ...
                            <div class="list__cat">
                                <span class="label list__cat-label-2">On Show</span>
                                <span class="price">
