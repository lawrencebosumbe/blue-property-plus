    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getKwazuluNatalSimilarPropertyOnShow() as $property):
						...
						$subSingleURL = URL.'kwazulu_natal/on_show_suburb/'.str_replace('', '_', trim($property->getSuburb()->getSuburbID())).'/';
						$citySingleURL = URL.'kwazulu_natal/on_show_city/'.str_replace('', '_', trim($property->getSuburb()->getCity()->getCityID())).'/';
					?>
