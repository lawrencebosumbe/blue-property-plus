    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Ray Nkonenyi</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getRayNkonenyiCities($municRow->getMunicipalityID()) as $property):
						...
						$propertySingleURL = URL.'ray_nkonenyi/'.'to_rent_city/'.$property->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getRayNkonenyiSubs($municRow->getMunicipalityID()) as $property):
						$propertyName = $property->getSuburbName();
						$propertySlug = str_replace('city of', '', strtolower($propertyName));
						$propertySlug = str_replace('city', '', $propertySlug);
						$propertySlug = str_replace(' ', '_', trim($propertySlug));
						$propertySingleURL = URL.'ray_nkonenyi/'.'on_show_suburb/'.$property->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getRayNkonenyiPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'ray_nkonenyi/'.'to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'ray_nkonenyi/'.'to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
