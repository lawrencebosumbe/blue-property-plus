    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getMakhadoCities($municRow->getMunicipalityID()) as $property):
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getMakhadoSubs($municRow->getMunicipalityID()) as $property):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getMakhadoPropertyListImagesForSale() as $property):
