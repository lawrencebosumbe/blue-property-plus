<?php
	class Matjhabeng extends Controller{
		...
		public function suburb($suburb_id){
			...
			$this->view->render('matjhabeng/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('matjhabeng/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('matjhabeng/to_rent_suburb/index');	
		}
		...
		public function city($city_id){
			...
			$this->view->render('matjhabeng/city');
		}
		...
		public function on_show_city($city_id){	
			...
			$this->view->render('matjhabeng/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('matjhabeng/to_rent_city/index');	
		}
		...
		public function gallery($property_id){
			...
			$this->view->render('matjhabeng/gallery');
		}
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('matjhabeng/on_show_gallery/index');
		}
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('matjhabeng/to_rent_gallery/index');
		}
	}