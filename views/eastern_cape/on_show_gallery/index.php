    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getFreeStateSimilarPropertyOnShow() as $property):
						...
						$subSingleURL = URL.'eastern_cape/on_show_suburb/'.str_replace('', '_', trim($property->getSuburb()->getSuburbID())).'/';
						$citySingleURL = URL.'eastern_cape/on_show_city/'.str_replace('', '_', trim($property->getSuburb()->getCity()->getCityID())).'/';
					?>
