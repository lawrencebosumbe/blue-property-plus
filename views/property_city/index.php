                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-8 connectedSortable">  
                            ...
                            <div class="box box-info">
                                ...
                                <form action="<?php echo URL; ?>property_city/addCity" method="post" name="postForm" 
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="suburb">City Details</label>
                                    <div class="form-group">
                                ...
                                <div class="box-footer clearfix">                                 	
                                    <button class="pull-right btn btn-primary" type="submit" name="submit">
                                     ...
                                     <a class="pull-right btn btn-primary" href="property_city/city_list">
                                     	View All Cities
                                    </a> 
                                </div>
                                </form>
