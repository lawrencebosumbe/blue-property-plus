<?php
	class Setseto extends Controller{
		...
		public function suburb($suburb_id){
			...
			$this->view->render('setseto/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('setseto/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('setseto/to_rent_suburb/index');	
		}
		...
		public function on_show_city($city_id){	
			...
			$this->view->render('setseto/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('setseto/to_rent_city/index');	
		}
		...
		public function gallery($property_id){
			...
			$this->view->render('setseto/gallery');
		}
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('setseto/on_show_gallery/index');
		}
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('setseto/to_rent_gallery/index');
		}
	}