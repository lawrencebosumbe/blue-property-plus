        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getNalediCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'naledi/'.'on_show_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getNalediSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'naledi/'.'on_show_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row">
					<?php foreach($properties->getNalediPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'naledi/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'naledi/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
