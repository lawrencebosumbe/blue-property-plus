                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li>
                                	<a href="Admin/Properties/manage_properties.html"><i class="fa fa-angle-double-right"></i> 	
                                		Manage Properties
                                    </a>
                               	</li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-8 connectedSortable">                                
                            ...
                            <div class="box box-info">
                                ...
                                <form id="regForm" action="<?php echo URL; ?>back_office/update_suburb/<?php echo $this->suburbs[0]['suburb_id']; ?>" method="post" 
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="code" id="code"
                                         placeholder="Suburb Code" value="<?php echo $this->suburbs[0]['code']; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="name" id="name"
                                         placeholder="Suburb Name" value="<?php echo $this->suburbs[0]['name']; ?>"/>
                                    </div>
