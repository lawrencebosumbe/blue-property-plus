<?php 
	...
	*/
    ...
    //get number of rows
    $rowCount = $cities->getPropertyByCityForSale($city->getCityID(), array('count'=>1));
    
    //initialize pagination class
    $pagConfig = array(
        'baseURL'=> URL.'/nkosazana_dlamini_zuma/city/'.$city->getCityID().'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
    ...
    //get rows
	$propertyData = $cities->getPropertyByCityForSale($city->getCityID(), array('limit'=>"$offset,$limit"));
    	...
    	<div class="container">
            ...
            <!-- END ROW -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    	<div class="ads-card"> 
                        	<h1>Properties for sale in <?php echo $city->getCityName(); ?></h1>
