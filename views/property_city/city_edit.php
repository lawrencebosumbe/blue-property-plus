                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-10 connectedSortable">  
                            ...
                            <div class="box box-info">
                                ...
                                <form action="<?php echo URL; ?>property_city/updateCity/<?php echo $city->getCityID();?>"
                                ...
                                <div class="box-body">        							
                                          ...
                                          <tr>
                                             ...
                                             <td width="15%">
                                                 <div class="form-group">
                                                 	<input type="hidden" value="<?php echo $city->getCityID();?>" name="city_id" />
                                                    <input type="text" value="<?php echo $city->getCityCode();?>" name="code" />
                                                 </div>														
                                             </td>
                                             <td width="35%">
                                                 <div class="form-group">
                                                    <input type="text" value="<?php echo $city->getCityName();?>" name="name" />
                                                 </div>														
                                             </td>
                                          </tr>
                                       </tbody>
                                    ...
                                    <button class="pull-right btn btn-info" type="submit">
                                    	<span class="glyphicon glyphicon-edit"> Update City </span>
                                    </button> 
                                </div>         							
                                </div>
                                </form>
