<?php
	class Nelson_Mandela_Bay extends Controller{
		public function __construct(){
			parent::__construct();
		}	
		
		public function index(){
			$this->view->render('nelson_mandela_bay/index');
		}
		
		//Get single suburb
		public function suburb($suburb_id){
			$suburb = $this->model->getSuburb($suburb_id);
			$this->view->nelson_mandela_bay = $suburb;
			$this->view->getSuburbImage = $this->model->getSuburbImage($suburb_id);
			if (empty($this->view->nelson_mandela_bay)) {
				die('This is an invalid suburb!');
			}
										
			$this->view->render('nelson_mandela_bay/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('nelson_mandela_bay/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('nelson_mandela_bay/to_rent_suburb/index');	
		}
		
		//Get single city
		public function city($city_id){
			$this->view->nelson_mandela_bay = $this->model->getCity($city_id);
			$this->view->getSuburbs = $this->model->getSuburbs();
			if (empty($this->view->nelson_mandela_bay)) {
			die('This is an invalid city!');
			}
											
			$this->view->render('nelson_mandela_bay/city');
		}
		
		public function on_show_city($city_id){	
			$city = $this->model->getCity($city_id);
			$this->view->nelson_mandela_bay = $city;
			$this->view->getSuburbImage = $this->model->getSuburbImage($city_id);
			if (empty($this->view->nelson_mandela_bay)) {
				die('This is an invalid city!');
			}
			$this->view->render('nelson_mandela_bay/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('nelson_mandela_bay/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->nelson_mandela_bay = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('nelson_mandela_bay/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->nelson_mandela_bay = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('nelson_mandela_bay/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->nelson_mandela_bay = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('nelson_mandela_bay/to_rent_gallery/index');
		}		
	}
