<?php
	class Buffalo_City extends Controller{
		public function __construct(){
			parent::__construct();
		}	
		
		public function index(){
			$this->view->render('buffalo_city/index');
		}
		
		//Get single suburb
		public function suburb($suburb_id){
			$suburb = $this->model->getSuburb($suburb_id);
			$this->view->buffalo_city = $suburb;
			$this->view->getSuburbImage = $this->model->getSuburbImage($suburb_id);
			if (empty($this->view->buffalo_city)) {
				die('This is an invalid suburb!');
			}
										
			$this->view->render('buffalo_city/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('buffalo_city/on_show_suburb/index');	
		}
		...
		public function to_rent_suburb($suburb_id){	
			...
			$this->view->render('buffalo_city/to_rent_suburb/index');	
		}
		
		//Get single city
		public function city($city_id){
			$this->view->buffalo_city = $this->model->getCity($city_id);
			$this->view->getSuburbs = $this->model->getSuburbs();
			if (empty($this->view->buffalo_city)) {
			die('This is an invalid city!');
			}
											
			$this->view->render('buffalo_city/city');
		}
		
		public function on_show_city($city_id){	
			$city = $this->model->getCity($city_id);
			$this->view->buffalo_city = $city;
			$this->view->getSuburbImage = $this->model->getSuburbImage($city_id);
			if (empty($this->view->buffalo_city)) {
				die('This is an invalid city!');
			}
			$this->view->render('buffalo_city/on_show_city/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('buffalo_city/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->buffalo_city = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('buffalo_city/gallery');
		}
		
		public function on_show_gallery($property_id){
			$this->view->buffalo_city = $this->model->getAgentPropertyImagesOnShow($property_id);
			...
			$this->view->render('buffalo_city/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
			$this->view->buffalo_city = $this->model->getAgentPropertyImagesToRent($property_id);
			...
			$this->view->render('buffalo_city/to_rent_gallery/index');
		}
	}
