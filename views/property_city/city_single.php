                        ...
                        <section class="col-lg-10 connectedSortable">  
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Listing Single City</h3>
                                </div>
                                <div class="box-body">        							
                                    	<table class='table table-hover table-responsive table-striped table-advance' width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="15%"><?php echo $city->getCityCode();?></td>
                                                    <td width="35%"><?php echo $city->getCityName();?></td>
                                                    <td width="45%">
                                                            ...
                                                            <a class="pull-right btn btn-info" 
                                                              href="<?php echo URL; ?>property_city/updateCity/<?php echo $city->
                                                              getCityID();?>">
