    ...
    <section>
    	...
    	<div class="container">
        	...
        	<div class="properties-listing similar-properties">
				...
				<div class="row">
                	<?php foreach($properties->getPhalaborwaSimilarPropertyToRent() as $property):
						...
						$subSingleURL = URL.'phalaborwa/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'phalaborwa/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
