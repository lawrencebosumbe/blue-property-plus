<?php 
	...
	$city = new KwazuluNatalProperty();
	$cities = new KwazuluNatalPropertyDB();
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getKwazuluNatalCities($row->getProvinceID()) as $city):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getKwazuluNatalPropertyListImagesForSale() as $property):
