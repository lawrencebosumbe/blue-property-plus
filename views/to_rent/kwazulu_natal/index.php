<?php 
	...
	$property = new KwazuluNatalProperty();	
	$properties = new KwazuluNatalPropertyDB();
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Kwazulu Natal</h1>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getKwazuluNatalMunicipality($prvRow->getProvinceID()) as $municipality):
                	...
                	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 municipality-link">
                    	...
                    	<ul> 
                        	<li>
                            <li><a href="<?php echo URL.'to_rent/'.$municpSlug; ?>/"><?php echo $municipality->getMunicipalityName(); ?></a></li></li>
                        </ul>
                    </div>
                     <?php endforeach; ?>
                </div>
                ...
                <div class="row city">       
                	<ul>       
                        <?php foreach($cities->getKwazuluNatalCities() as $city): ?> 
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getKwazuluNatalPropertyListImagesOnShow() as $property):
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    	...
                    	<div class="properties item--category-1">
                            ...
                            <div class="list__cat">
                                <span class="label list__cat-label-1">On Show</span>
                                <span class="price">
