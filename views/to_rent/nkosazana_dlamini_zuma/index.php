...
<title>Nkosazana Dlamini Zuma</title>
<!--
 ---------------------------------------------------------------
       STYLES
 ---------------------------------------------------------------
    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Nkosazana Dlamini Zuma</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getNkosazanaDlaminiZumaCities($municRow->getMunicipalityID()) as $property):
						$propertyName = $property->getCityName();
						$propertySlug = str_replace('city of', '', strtolower($propertyName));
						$propertySlug = str_replace('city', '', $propertySlug);
						$propertySlug = str_replace(' ', '_', trim($propertySlug));
						$propertySingleURL = URL.'nkosazana_dlamini_zuma/'.'to_rent_city/'.$property->getCityID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
                          	<a href="<?php echo $propertySingleURL; ?>"><?php echo $property->getCityName(); ?></a>
                            <span class="num-suburbs">
                               <?php 
                                  echo $property->getTotalPropertyToRent();
                               ?>
                         	</span>
                          </li>
                       </ul> 
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getNkosazanaDlaminiZumaSubs($municRow->getMunicipalityID()) as $property):
						$propertyName = $property->getSuburbName();
						$propertySlug = str_replace('city of', '', strtolower($propertyName));
						$propertySlug = str_replace('city', '', $propertySlug);
						$propertySlug = str_replace(' ', '_', trim($propertySlug));
						$propertySingleURL = URL.'nkosazana_dlamini_zuma/'.'to_rent_suburb/'.$property->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
                          	<a href="<?php echo $propertySingleURL; ?>"><?php echo $property->getSuburbName(); ?></a>
                            <span class="num-suburbs">
                               <?php 
                                  echo $property->getTotalPropertyToRent();
                               ?>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getNkosazanaDlaminiZumaPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'nkosazana_dlamini_zuma/'.'to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'nkosazana_dlamini_zuma/'.'to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
