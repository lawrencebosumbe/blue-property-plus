<?php
	class Kwazulu_Natal_Model {
		...
		//Get All municipalities in Kwazulu Natal
		public function getKwazuluNatalgMunicipalities(){
			try{
		...
		*/
		...
		public function getSuburb($suburb_id){
			try{
				$query = "SELECT s.*, p.province_name, p.province_code, p.province_id,
				...
				//create province object
				$province = new Province();
				$province->ProvinceID($row['province_id']);
				$province->ProvinceCode($row['province_code']);
				$province->ProvinceName($row['province_name']);
		...
		public function getCity($city_id){
			try{
				$query = "SELECT c.*, p.province_name, p.province_code, p.province_id,
						  m.municipality_name, m.municipality_code, m.municipality_id
						  FROM cities c
						  LEFT JOIN municipalities m
						  ON c.municipality_id = m.municipality_id
