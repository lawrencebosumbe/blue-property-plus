<?php
	class Nkandla extends Controller{
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('nkandla/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('nkandla/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->nkandla = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('nkandla/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->nkandla = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('nkandla/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->nkandla = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('nkandla/to_rent_gallery/index');
		}
	}