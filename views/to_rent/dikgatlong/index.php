    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Dikgatlong</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getDikgatlongCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'dikgatlong/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getDikgatlongSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'dikgatlong/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getDikgatlongPropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'dikgatlong/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'dikgatlong/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
