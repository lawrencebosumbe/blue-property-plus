    ...
    <div class="banner">
		<div class="arrow-division"> 
              ...
              <div class="menu searchFormTab">
                <ul>
                    <li><a href="<?php echo URL; ?>on_show/" class="active">On Show</a></li>
    ...
    <section class="content-bg-gray">
       ...
       <div class="container">
        	...
        	<div class="properties-listing">
            	...
            	<h3>Listed properties on Show</h3>
    	...
    	<!-- CONTAINER -->
         <div class="container">
            ...
            <div class="property-location">
                ...
                <h1>Property On Show in South Africa</h1>
				<?php
				...
				?>
                <p><a href="<?php echo URL.'on_show/'.$provinceSlug; ?>/"><?php echo $provinceName;?></a></p> 
                <div class="row">               
