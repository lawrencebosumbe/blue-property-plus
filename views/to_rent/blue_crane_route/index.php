    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getBlueCraneRouteCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'blue_crane_route/to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getBlueCraneRouteSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'blue_crane_route/to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getBlueCraneRoutePropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'blue_crane_route/to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'blue_crane_route/to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
