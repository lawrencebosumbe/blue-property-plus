<?php 
	...
	$municipalities = new NorthWestPropertyDB();
	$municipality = new NorthWestProperty();
	
	//$municipal = new Municipality();
	//$municipals = new MunicipalityDB();
		
	$city = new NorthWestProperty();
	$cities = new NorthWestPropertyDB();
	
	$property = new NorthWestProperty();	
	$properties = new NorthWestPropertyDB();
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">North West</h1>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getNorthWestMunicipality($prvRow->getProvinceID()) as $municipality):
                ...
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getNorthWestCities($row->getProvinceID()) as $city):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getNorthWestPropertyListImagesToRent() as $property):
