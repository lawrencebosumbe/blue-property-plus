    ...
    <div class="banner">
		<div class="arrow-division"> 
              ...
              <div class="menu searchFormTab">
                <ul>
                    <li><a href="<?php echo URL; ?>on_show/" class="active">To Rent</a></li>
                    <li><a href="<?php echo URL; ?>">For Sale</a></li>
                    <li><a href="<?php echo URL; ?>to_rent/">On Show</a></li>
            ...
            <div style="position:relative;top:0;left:0;width:100%;height:100%;overflow:hidden;">
                ...
                text-align:center;background-color:rgba(0,0,0,0.7);">
                    <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<?php echo URL; ?>public/images/img/spin.svg" />
                </div>
    ...
    <section class="content-bg-gray">
       ...
       <div class="container">
        	...
        	<div class="properties-listing">
            	...
            	<h3>Listed properties to rent</h3>
    	...
    	<!-- CONTAINER -->
         <div class="container">
            ...
            <div class="property-location">
                ...
                <h1>Property To Rent in South Africa</h1>
				<?php
				...
				?>
                <p><a href="<?php echo URL.'to_rent/'.$provinceSlug; ?>/"><?php echo $provinceName;?></a></p> 
                <div class="row">               
         ...
         <div class="container">
            ...
            <div class="row">
                 <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 property-listing">
                 	<figure>
                 		<img src="<?php echo URL; ?>public/images/properties/001.jpg"/>
                    </figure>
                    ...
                    <div class="bg-x-tra-light-blue">List For Sale</div>
                 </div>
                 <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 property-listing">
                 	<figure>
                 		<img src="<?php echo URL; ?>public/images/properties/003.jpg"/>
                    </figure>
                    ...
                    <div class="bg-cat-label-2">List To Rent</div>
                 </div>
                 <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 property-listing">
                 	<figure>
                 	<img src="<?php echo URL; ?>public/images/properties/002.jpg"/>
                    </figure>
                    ...
                    <h2 id="location"></h2>                  
                    <div class="bg-cat-label-4">List on Show</div>                                       
                 </div>                 
            </div>
            <!-- END ROW -->
    	...
    	<div class="container">
            ...
            <div class="row">            
            	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <figure>
                    	<img src="<?php echo URL; ?>public/images/responsive-devices/front-device.png"/>
                    </figure>
