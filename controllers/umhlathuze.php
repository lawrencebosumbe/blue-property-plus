<?php
	class Umhlathuze extends Controller{
		...
		public function suburb($suburb_id){
			...
			$this->view->umhlathuze = $suburb;
			$this->view->getSuburbImage = $this->model->getSuburbImage($suburb_id);
			if (empty($this->view->umhlathuze)) {
				die('This is an invalid suburb!');
			}
										
			$this->view->render('umhlathuze/suburb');
		}
		...
		public function on_show_suburb($suburb_id){	
			...
			$this->view->render('umhlathuze/on_show_suburb/index');	
		}
		...
		public function to_rent_city($city_id){	
			...
			$this->view->render('umhlathuze/to_rent_city/index');	
		}
		
		//Get single image
		public function gallery($property_id){
			$this->view->umhlathuze = $this->model->getAgentPropertyImagesForSale($property_id);
			...
			$this->view->render('umhlathuze/gallery');
		}
		
		public function on_show_gallery($property_id){
		$this->view->umhlathuze = $this->model->getAgentPropertyImagesOnShow($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentOnShow($property_id);
			...
			$this->view->render('umhlathuze/on_show_gallery/index');
		}
		
		public function to_rent_gallery($property_id){
		$this->view->umhlathuze = $this->model->getAgentPropertyImagesToRent($property_id);
		...
		$this->view->getPropertyAgent = $this->model->getPropertyAgentToRent($property_id);
			...
			$this->view->render('umhlathuze/to_rent_gallery/index');
		}
	}