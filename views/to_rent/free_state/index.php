<?php 
	...
	$municipalities = new FreeStatePropertyDB();
	$municipality = new FreeStateProperty();
    ...
    <section>  
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Free State</h1>
                ...
                <div class="row municipality">
                        <?php foreach($municipalities->getFreeStateMunicipality($prvRow->getProvinceID()) as $municipality):
                ...
                <!-- ROW -->
                <div class="row city"> 
                	<?php foreach($cities->getFreeStateCities($row->getProvinceID()) as $city):
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getFreeStatePropertyListImagesToRent() as $property):
