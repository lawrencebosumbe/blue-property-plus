<?php 	
	...
	$province_id = isset($_GET['province_id']) ? $_GET['province_id'] : "5";		
    ...
    $pagConfig = array(
        'baseURL'=> URL.'/limpopo/suburb/'.str_replace('', '_', trim($suburb->getSuburbID())).'/',
        'totalRows'=>$rowCount,
        'perPage'=>$limit
    );
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="card">                            	
                            ...
                            <div class="card-img item--category-1">
                                <figure>
                                    <a href="<?php echo URL; ?>limpopo/gallery/<?php echo $suburb->getPropertyID(); ?>">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'limpopo/city/'.$town->getCityID(); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                        	...
                        	<!-- CITY TEXT -->
                            <div class="city-text">
                            	<h4>Municipalities in Limpopo</h4>
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'limpopo/'.str_replace(' ', '_', trim($municipality->getMunicipalityName())); ?>">
                        ...
                        <div class="city-item image-rotate wow zoomIn" data-wow-delay="300ms" data-wow-duration="500ms">
                            ...
                            <div class="city-text">
                                ...
                                <ul>
									...
									<li>
                                    	<a href="<?php echo URL.'limpopo/suburb/'.str_replace('', '_', trim($suburb->getSuburbID())); ?>">
											<?php echo $suburb->getSuburbName(); ?>
                                        </a>
                                    	<span class="num-suburbs">
                                               <?php 
