                	...
                	<ul>       
                        <?php foreach($cities->getWesternCapeCities() as $city): ?> 
                      		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">                               
                               	<li>
                                   <a href="<?php echo URL; ?>to_rent/city/<?php echo $city->getCityID();?>">	
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
                	<?php foreach($properties->getWesternCapePropertyListImagesToRent() as $property):
						$municpName = $property->getSuburb()->getCity()->getMunicipality()->getMunicipalityName();
						$municpSlug = str_replace('city of', '', strtolower($municpName));
						$municpSlug = str_replace('city', '', $municpSlug);
						$municpSlug = str_replace(' ', '_', trim($municpSlug));
						$subSinURL = URL.'to_rent/'.'suburb/'.$property->getSuburb()->getSuburbID().'/';
						$subrURL = URL.'to_rent/'.'city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
