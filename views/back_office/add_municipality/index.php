<?php
	...
	//$suburb = $suburbs->getSuburbs($suburb_id);
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-8 connectedSortable">                                
                            ...
                            <div class="box box-info">
                                ...
                                <form id="regForm" action="<?php echo URL; ?>back_office/add_municipality" method="post" 
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">                                                                        
                                        <label for="municipality">Municipality Details</label>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="box-footer clearfix">
                                    <button class="pull-right btn btn-primary" id="btnMunicipality" type="submit"
                                      name="submit">
                                    	Add Municipality <i class="fa fa-arrow-circle-right"></i>
                                    </button>
                                </div>
                                </form>
                            </div>
