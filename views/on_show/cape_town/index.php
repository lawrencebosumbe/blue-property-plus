    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Cape Town</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getCapeTownCities($municRow->getMunicipalityID()) as $city):
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getCapeTownSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'cape_town/'.'on_show_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getCapeTownPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'cape_town/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'cape_town/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
