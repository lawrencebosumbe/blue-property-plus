    ...
    <section> 
    	...
    	<div class="container">  
        	...
        	<div class="province-container">
                ...
                <h1 style="text-align:center">Tswelopele</h1>
                ...
                <div class="row municipality"> 
                	<?php foreach($cities->getTswelopeleCities($municRow->getMunicipalityID()) as $city):
						...
						$citySingleURL = URL.'tswelopele/'.'to_rent_city/'.$city->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($suburbs->getTswelopeleSubs($municRow->getMunicipalityID()) as $suburb):
						...
						$suburbSingleURL = URL.'tswelopele/'.'to_rent_suburb/'.$suburb->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
				...
				<div class="row"> 
					<?php foreach($properties->getTswelopelePropertyListImagesToRent() as $property):
						...
						$subSingleURL = URL.'tswelopele/'.'to_rent_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'tswelopele/'.'to_rent_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
