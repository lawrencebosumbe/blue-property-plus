        	...
        	<div class="province-container">
                ...
                <div class="row municipality"> 
                	<?php foreach($properties->getEndumeniCities($municRow->getMunicipalityID()) as $property):
						...
						$propertySingleURL = URL.'endumeni/'.'on_show_city/'.$property->getCityID().'/';
					?>
                ...
                <div class="row suburb"> 
                	<?php foreach($properties->getEndumeniSubs($municRow->getMunicipalityID()) as $property):
						...
						$propertySlug = str_replace('city', '', $propertySlug);
						$propertySlug = str_replace(' ', '_', trim($propertySlug));
						$propertySingleURL = URL.'endumeni/'.'on_show_suburb/'.$property->getSuburbID().'/';
					?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                       <ul>
                          <li>
       ...
       <!-- CONTAINER -->
    	<div class="container">
        	...
        	<div class="properties-listing">
                ...
                <!-- ROW -->
				<div class="row">
					<?php foreach($properties->getEndumeniPropertyListImagesOnShow() as $property):
						...
						$subSingleURL = URL.'endumeni/'.'on_show_suburb/'.$property->getSuburb()->getSuburbID().'/';
						$citySingleURL = URL.'endumeni/'.'on_show_city/'.$property->getSuburb()->getCity()->getCityID().'/';
					?>
